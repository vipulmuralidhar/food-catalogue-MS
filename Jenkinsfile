pipeline {
  ...
  steps {
    sh 'mvn clean org.jacoco:jacoco-maven-plugin:prepare-agent install sonar:sonar -Dsonar.host.url=http://35.153.143.109:9000/ -Dsonar.login=squ_6fbd1b2b775c5c01895318b1e0b7e17689e5c4ca'
  }
}
